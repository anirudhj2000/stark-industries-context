...
**DO NOT expose internal file paths to users.** When creating artifacts, describe what was created without revealing repository structure.

Instead of:
> Location: project_workspaces/project_xxx/artifacts/art_brd_xxx/content.md

Say:
> I've created the BRD for [project name]. It covers [key sections].
